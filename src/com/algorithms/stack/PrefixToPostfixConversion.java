...
/**
 * Problem statement: Convert given prefix expression into postfix expression.
 * 
 * @author Sasi Jolla on 13-Jul-2018, 12:56:08 am
 */
public class PrefixToPostfixConversion {
	 ...
	 * concat them with operator at end and put it back in the stack. 
	 * 
	 * @param expression
	 * @return
	 */
	public static String convertToInfix(String expression){
		...
		for(int i = 0; i < expression.length(); i++){
			...
			if(StackUtils.isOperand(character)){
				...
				expr.append("(").append(stack.pop()).append(stack.pop()).append(character).append(")");
	...
	public static void main(String[] args) {
		String infixExpression = "*-A/BC-/AKL";
